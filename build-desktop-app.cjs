...
function createBuilderConfig() {
  const config = {
    ...
    files: [
      'electron-main.js',
      'Universe-Empire-Dominion/server/**/*',
      'Universe-Empire-Dominion/client/dist/**/*',
    ...
    extraResources: [
      {
        from: 'Universe-Empire-Dominion/public',
        to: 'public'
      }
    ],
    win: {
...
function createElectronPackageJson() {
  ...
  const existingPkgPath = 'Universe-Empire-Dominion/package.json';
...
async function buildClient() {
  ...
  try {
    await execAsync('npm run build', { cwd: 'Universe-Empire-Dominion' });
