...
import { GENERATED_GAME_ART, SHIP_ASSETS, MENU_ASSETS, OGAMEX_FEATURED_ASSETS, PLANET_ASSETS, TECH_BRANCH_ASSETS } from "@shared/config";
      ...
      <div className="space-y-8 animate-in fade-in duration-500">
        ...
        <section className="overflow-hidden rounded-2xl border border-slate-200 shadow-sm bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(15,23,42,0.78), rgba(15,23,42,0.92)), url(${GENERATED_GAME_ART.GALAXY_COMMAND_HERO.path})` }}>
          <div className="p-5 lg:p-6 space-y-4 text-white">
            ...
            <p className="text-sm leading-6 text-slate-300">Overview and management of your empire's core metrics, fleet strength, research progress, and active operations.</p>
            <div className="flex flex-wrap gap-3">
              {[{ label: "Dashboard", image: MENU_ASSETS.NAVIGATION.HOME.path }, { label: "Fleet Power", image: SHIP_ASSETS.CAPITALS.BATTLECRUISER.path }, { label: "Shipyard Carrier", image: GENERATED_GAME_ART.SHIPYARD_CARRIER.path }, { label: "Mining Frontier", image: GENERATED_GAME_ART.ASTEROID_MINING_FRONTIER.path }, { label: "Empire", image: MENU_ASSETS.NAVIGATION.EMPIRE.path }].map((item) => (
