...
import { BACKGROUND_ASSETS, SHIP_ASSETS, MENU_ASSETS, OGAMEX_FEATURED_ASSETS, PLANET_ASSETS, TECH_BRANCH_ASSETS } from "@shared/config";
        ...
        <section className="overflow-hidden rounded-2xl border border-slate-200 shadow-sm bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(15,23,42,0.78), rgba(15,23,42,0.92)), url(${BACKGROUND_ASSETS.GALAXY_MAP.path})` }}>
          <div className="p-5 lg:p-6 space-y-4 text-white">
            ...
            <div className="flex flex-wrap gap-3">
              {[{ label: "Dashboard", image: MENU_ASSETS.NAVIGATION.HOME.path }, { label: "Fleet Power", image: SHIP_ASSETS.CAPITALS.BATTLECRUISER.path }, { label: "Empire", image: MENU_ASSETS.NAVIGATION.EMPIRE.path }].map((item) => (
