        ...
        <section className="overflow-hidden rounded-2xl border border-slate-200 shadow-sm bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(15,23,42,0.78), rgba(15,23,42,0.92)), url(${BACKGROUND_ASSETS.COMBAT.path})` }}>
          <div className="p-5 lg:p-6 space-y-4 text-white">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold">Fleet Combat</h1>
            </div>
            <p className="text-sm leading-6 text-slate-300">Engage in tactical battles, defend your empire, and plunder resources.</p>
            <div className="flex flex-wrap gap-3">
              {[{ label: "Battleships", image: SHIP_ASSETS.CAPITALS.BATTLESHIP.path }, { label: "Interceptors", image: SHIP_ASSETS.FIGHTERS.INTERCEPTOR.path }, { label: "Combat Ready", image: MENU_ASSETS.NAVIGATION.MILITARY.path }].map((item) => (
