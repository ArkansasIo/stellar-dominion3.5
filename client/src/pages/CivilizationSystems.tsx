        ...
        <section className="overflow-hidden rounded-2xl border border-slate-200 shadow-sm bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(15,23,42,0.78), rgba(15,23,42,0.92)), url(${BACKGROUND_ASSETS.STAR_FIELD.path})` }}>
          <div className="p-5 lg:p-6 space-y-4 text-white">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold">Civilization Workforce</h1>
            </div>
            <p className="text-sm leading-6 text-slate-300">Manage 90+ specialized roles across civilization and military domains with dynamic resource demands</p>
            <div className="flex flex-wrap gap-3">
              {[{ label: "Workforce Management", image: SHIP_ASSETS.CAPITALS.BATTLECRUISER.path }, { label: "Civilian Roles", image: MENU_ASSETS.BUILDINGS.SHIPYARD.path }, { label: "Resource Allocation", image: OGAMEX_FEATURED_ASSETS.BACKGROUND.path }].map((item) => (
