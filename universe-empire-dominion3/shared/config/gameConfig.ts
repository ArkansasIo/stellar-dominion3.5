...
export const NPC_VENDORS = [
  ...
  {
    id: "merchant_voss_exclusive",
    name: "Trade Master Voss",
    faction: "merchant_guilds",
    location: "Commerce Hub Nexus",
    specialty: "Bulk resource trading and market intelligence",
    reputation_required: 80,
    inventory: ["resource_metal_bulk", "resource_crystal_bulk", "resource_deuterium_bulk", "market_intel_report"],
  },
  {
    id: "emperor_hadrian_legate",
    name: "Legate Hadrian",
    faction: "terran_empire",
    location: "Terra Prime - Imperial Palace",
    specialty: "Imperial technology and diplomatic credentials",
    reputation_required: 120,
    inventory: ["imperial_fleet_pass", "diplomatic_immunity_card", "terran_fleet_upgrade"],
  },
  {
    id: "nexus_collective_node",
    name: "Nexus Collective Node",
    faction: "zyx_collective",
    location: "Zyx-9 Central Hub",
    specialty: "Silicon-based technology and data cores",
    reputation_required: 140,
    inventory: ["zyx_data_core", "silicon_neural_implant", "collective_upgrade_module"],
  },
  {
    id: "dr_synthesis_prime",
    name: "Dr. Synthesis Prime",
    faction: "xenobiology_institute",
    location: "Research Station Genesis",
    specialty: "Xenobiological research and genetic modifications",
    reputation_required: 160,
    inventory: ["genetic_mod_pack", "xeno_specimen", "biotech_enhancement"],
  },
  {
    id: "first_guardian_elder",
    name: "Elder Guardian",
    faction: "eternal_watchers",
    location: "The Eternal Observatory",
    specialty: "Ancient wisdom and cosmic artifacts",
    reputation_required: 200,
    inventory: ["cosmic_wisdom_scroll", "eternal_relic", "guardian_blessing"],
  },
  {
    id: "president_charter_aide",
    name: "Envoy Charter",
    faction: "free_alliance",
    location: "Liberty Station",
    specialty: "Democratic trade agreements and civil rights",
    reputation_required: 100,
    inventory: ["trade_agreement_treaty", "civil_rights_charter", "alliance_membership_card"],
  },
];
