...
const STORE_CATALOG_BLUEPRINT: Array<Omit<StorefrontItem, 'grantItemId'>> = [
  ...
  {
    id: 'store-booster-4',
    name: 'Fleet Experience Surge',
    category: 'boosters',
    description: 'Doubles fleet XP gains for 24 hours. Stackable up to 3x.',
    currency: 'gold',
    price: 150,
    grantQuantity: 1,
    tags: ['fleet', 'xp', 'booster', 'military'],
  },
  {
    id: 'store-booster-5',
    name: 'Mining Yield Amplifier',
    category: 'boosters',
    description: 'Increases all resource mining output by 50% for 12 hours.',
    currency: 'silver',
    price: 8000,
    grantQuantity: 1,
    tags: ['mining', 'resources', 'booster', 'economy'],
  },
  {
    id: 'store-booster-6',
    name: 'Research Velocity Core',
    category: 'boosters',
    description: 'Accelerates all active research projects by 40% for 8 hours.',
    currency: 'gold',
    price: 120,
    grantQuantity: 1,
    tags: ['research', 'technology', 'booster'],
  },
  {
    id: 'store-booster-7',
    name: 'Trade Route Optimizer',
    category: 'boosters',
    description: 'Reduces trade fees by 25% and increases market order fill rates for 24 hours.',
    currency: 'silver',
    price: 6000,
    grantQuantity: 1,
    tags: ['trade', 'market', 'booster', 'economy'],
  },
  {
    id: 'store-cosmetic-4',
    name: 'Imperial Fleet Livery',
    category: 'cosmetics',
    description: 'Apply the official Terran Empire fleet color scheme to all your ships.',
    currency: 'platinum',
    price: 16,
    grantQuantity: 1,
    tags: ['cosmetic', 'ships', 'livery', 'empire'],
  },
  {
    id: 'store-cosmetic-5',
    name: 'Commander Portrait: War Hero',
    category: 'cosmetics',
    description: 'Exclusive animated commander portrait with battle-scarred visor effect.',
    currency: 'platinum',
    price: 10,
    grantQuantity: 1,
    tags: ['cosmetic', 'commander', 'portrait'],
  },
  {
    id: 'store-cosmetic-6',
    name: 'Animated War Banner',
    category: 'cosmetics',
    description: 'A shimmering animated banner for your empire profile display.',
    currency: 'gold',
    price: 200,
    grantQuantity: 1,
    tags: ['cosmetic', 'banner', 'profile'],
  },
  {
    id: 'store-cosmetic-7',
    name: 'Planet Surface: Terran Colony',
    category: 'cosmetics',
    description: 'Customize your colony surface appearance with a lush Terran biome.',
    currency: 'platinum',
    price: 20,
    grantQuantity: 1,
    tags: ['cosmetic', 'planet', 'colony'],
  },
  {
    id: 'store-resource-4',
    name: 'Deuterium Fuel Reserve',
    category: 'resources',
    description: 'Bulk deuterium for fleet operations and warp drive charging.',
    currency: 'silver',
    price: 28000,
    grantQuantity: 6,
    tags: ['resources', 'deuterium', 'fuel'],
  },
  {
    id: 'store-resource-5',
    name: 'Mixed Resource Crate',
    category: 'resources',
    description: 'Balanced crate of metal, crystal, and deuterium for general use.',
    currency: 'silver',
    price: 40000,
    grantQuantity: 5,
    tags: ['resources', 'crate', 'mixed'],
  },
  {
    id: 'store-resource-6',
    name: 'Energy Cell Pack',
    category: 'resources',
    description: 'Compact energy cells to boost power grid output across colonies.',
    currency: 'silver',
    price: 15000,
    grantQuantity: 10,
    tags: ['resources', 'energy', 'power'],
  },
  {
    id: 'store-bundle-4',
    name: 'Warlord Starter Pack',
    category: 'bundles',
    description: 'Military-focused bundle: fleet booster, shipyard rush token, and combat XP boost.',
    currency: 'gold',
    price: 350,
    grantQuantity: 1,
    tags: ['military', 'bundle', 'combat'],
  },
  {
    id: 'store-bundle-5',
    name: 'Explorer Discovery Kit',
    category: 'bundles',
    description: 'Exploration bundle: star charts, warp fuel, and exploration XP booster.',
    currency: 'gold',
    price: 280,
    grantQuantity: 1,
    tags: ['exploration', 'bundle', 'discovery'],
  },
  {
    id: 'store-bundle-6',
    name: 'Commander Ascension Pack',
    category: 'bundles',
    description: 'Level-up bundle: commander XP boost, skill reset token, and talent points.',
    currency: 'platinum',
    price: 30,
    grantQuantity: 1,
    tags: ['commander', 'bundle', 'progression'],
  },
  {
    id: 'store-bundle-7',
    name: 'Full Cosmetics Collection',
    category: 'bundles',
    description: 'Unlock all current cosmetic items at a discounted bundle rate.',
    currency: 'platinum',
    price: 45,
    grantQuantity: 1,
    tags: ['cosmetic', 'bundle', 'premium', 'collection'],
  },
];
