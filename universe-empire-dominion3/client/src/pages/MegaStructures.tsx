  ...
  return (
    <GameLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-4xl font-bold text-[var(--sd-text-primary)]">Megastructures</h1>
          <p className="mt-2 text-[var(--sd-text-secondary)]">All 18 megastructure categories now have their own upgrade systems, layered on top of the existing cosmic build projects.</p>
        </div>

        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
          <Card className="border-[var(--sd-panel-border)] bg-[var(--sd-panel-top)]">
            <CardContent className="pt-6">
              <div className="text-xs uppercase tracking-widest text-[var(--sd-text-secondary)]">Category Systems</div>
              <div className="mt-1 text-2xl font-bold text-[var(--sd-text-primary)]">{categoryStates.length}</div>
            </CardContent>
          </Card>
          <Card className="border-[var(--sd-panel-border)] bg-[var(--sd-panel-top)]">
            <CardContent className="pt-6">
              <div className="text-xs uppercase tracking-widest text-[var(--sd-text-secondary)]">Active Categories</div>
              <div className="mt-1 text-2xl font-bold text-emerald-700">{activeCategories}</div>
            </CardContent>
          </Card>
          <Card className="border-[var(--sd-panel-border)] bg-[var(--sd-panel-top)]">
            <CardContent className="pt-6">
              <div className="text-xs uppercase tracking-widest text-[var(--sd-text-secondary)]">Total Category Levels</div>
        ...
        <Card className="border-[var(--sd-panel-border)] bg-[var(--sd-panel-bottom)]">
          ...
          <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
            {categoryStates.map((system) => {
              ...
              return (
                <Card key={system.id} className={cn("border-[var(--sd-panel-border)] bg-[var(--sd-panel-top)] shadow-sm", !system.unlocked && "opacity-80")}>
                  <CardHeader className="pb-2">
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <CardTitle className="text-base text-[var(--sd-text-primary)]">{system.label}</CardTitle>
                          <div className="text-xs uppercase tracking-[0.18em] text-[var(--sd-text-secondary)]">Category mastery level {system.level}</div>
                        </div>
                      </div>
                      <Badge variant="outline" className="bg-[var(--sd-panel-bottom)] text-[var(--sd-text-secondary)]">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="rounded-lg border border-[var(--sd-panel-border)] bg-[var(--sd-panel-bottom)] p-3">
                      <div className="text-xs uppercase tracking-widest text-[var(--sd-text-secondary)]">Strategic Doctrine</div>
                      <div className="mt-1 text-sm font-medium text-[var(--sd-text-primary)]">{system.doctrine}</div>
                    </div>
                    ...
                    <div className="rounded-lg border border-dashed border-[var(--sd-panel-border)] bg-[var(--sd-panel-top)] p-3 text-sm">
                      <div className="mb-2 text-xs uppercase tracking-widest text-[var(--sd-text-secondary)]">Unlock Gate</div>
                    ...
                    <div className="rounded-lg border border-[var(--sd-panel-border)] bg-[var(--sd-panel-bottom)] p-3 text-sm">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center justify-between pt-1 text-xs text-[var(--sd-text-secondary)]">
        ...
        <Card className="border-[var(--sd-panel-border)] bg-[var(--sd-panel-top)]">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-[var(--sd-text-secondary)]">Existing megastructure projects remain constructable here. Category mastery upgrades now sit above them and improve the strategic value of each class.</p>
            ...
            <Tabs defaultValue={constructableCategories[0]?.id || "infrastructure"} className="w-full">
              <TabsList className="flex h-auto w-full flex-wrap justify-start gap-2 border border-[var(--sd-panel-border)] bg-[var(--sd-panel-bottom)] p-2">
                {constructableCategories.map((category) => (
                  <TabsTrigger key={category.id} value={category.id} className="capitalize data-[state=active]:bg-[var(--sd-panel-top)]">
                    {category.label}
                  </TabsTrigger>
                ))}
              </TabsList>
                  ...
                  <TabsContent key={category.id} value={category.id} className="mt-6 space-y-4">
                    <div className="rounded-lg border border-[var(--sd-panel-border)] bg-[var(--sd-panel-bottom)] p-4">
                      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                        <div>
                          <div className="text-xs uppercase tracking-[0.18em] text-[var(--sd-text-secondary)]">{category.label}</div>
                          <div className="mt-1 text-sm text-[var(--sd-text-secondary)]">{category.description}</div>
                        </div>
                    ...
                    {structures.length === 0 ? (
                      <Card className="border-dashed border-slate-300 bg-[var(--sd-panel-bottom)]">
                        <CardContent className="p-6 text-sm text-[var(--sd-text-secondary)]">
                      ...
                      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        {structures.map((structure) => {
                          ...
                          return (
                            <Card key={structure.id} className="border-[var(--sd-panel-border)] bg-[var(--sd-panel-top)] shadow-sm">
                              <CardHeader className="pb-2">
                                <div className="flex items-start justify-between gap-3">
                                  <div>
                                    <CardTitle className="text-lg text-[var(--sd-text-primary)]">{structure.name}</CardTitle>
                                    <div className="mt-1 text-xs uppercase tracking-[0.18em] text-[var(--sd-text-secondary)]">{structure.type.replace(/_/g, " ")}</div>
                                  </div>
                                  <Badge variant="outline" className="bg-[var(--sd-panel-bottom)] text-[var(--sd-text-secondary)]">
                                    Tier {structure.tier}
                                  </Badge>
                              ...
                              <CardContent className="space-y-4">
                                <p className="text-sm text-[var(--sd-text-secondary)]">{structure.description}</p>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                  <div className="rounded-lg border border-[var(--sd-panel-border)] bg-[var(--sd-panel-bottom)] p-3">
                                    <div className="text-xs uppercase tracking-widest text-[var(--sd-text-secondary)]">Energy</div>
                                    <div className="mt-1 text-lg font-bold text-yellow-700">{structure.stats.energyOutput.toLocaleString()}</div>
                                  </div>
                                  <div className="rounded-lg border border-[var(--sd-panel-border)] bg-[var(--sd-panel-bottom)] p-3">
                                    <div className="text-xs uppercase tracking-widest text-[var(--sd-text-secondary)]">Research</div>
                                    <div className="mt-1 text-lg font-bold text-violet-700">+{structure.stats.researchBonus}%</div>
                                  </div>
                                  <div className="rounded-lg border border-[var(--sd-panel-border)] bg-[var(--sd-panel-bottom)] p-3">
                                    <div className="text-xs uppercase tracking-widest text-[var(--sd-text-secondary)]">Production</div>
                                    <div className="mt-1 text-lg font-bold text-emerald-700">+{structure.stats.productionBonus}%</div>
                                  </div>
                                  <div className="rounded-lg border border-[var(--sd-panel-border)] bg-[var(--sd-panel-bottom)] p-3">
                                    <div className="text-xs uppercase tracking-widest text-[var(--sd-text-secondary)]">Population</div>
                                ...
                                <div className="rounded-lg border border-[var(--sd-panel-border)] bg-[var(--sd-panel-bottom)] p-3 text-sm">
                                  ...
                                  <div className="space-y-1">
                                    <div className="flex items-center justify-between"><span className="text-[var(--sd-text-secondary)]">Metal</span><span>{cost.metal.toLocaleString()}</span></div>
                                    <div className="flex items-center justify-between"><span className="text-[var(--sd-text-secondary)]">Crystal</span><span>{cost.crystal.toLocaleString()}</span></div>
                                    <div className="flex items-center justify-between"><span className="text-[var(--sd-text-secondary)]">Deuterium</span><span>{cost.deuterium.toLocaleString()}</span></div>
                                    <div className="flex items-center justify-between pt-1 text-xs text-[var(--sd-text-secondary)]"><span>Build Time</span><span>{structure.stats.constructionTime.toLocaleString()} turns</span></div>
                                  </div>
                                </div>
