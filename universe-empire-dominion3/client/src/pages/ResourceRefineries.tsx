...
const RESOURCE_COLORS: Record<string, string> = {
  metal: "text-[var(--sd-text-secondary)]",
  ...
  return (
    <Card className="relative overflow-hidden">
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={cn("p-2 rounded-lg bg-[var(--sd-panel-bottom)]", typeDef.color)}>
      ...
      <CardContent className="space-y-3">
        ...
        {/* Active Recipe */}
        {refinery.recipe ? (
          <div className="p-2 rounded bg-[var(--sd-panel-bottom)] border text-xs space-y-1">
          ...
          <div className="p-2 rounded bg-[var(--sd-panel-bottom)] border text-xs text-muted-foreground">
            No recipe selected
          </div>
        )}
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-[var(--sd-panel-bottom)] rounded-lg p-4 border border-[var(--sd-panel-border)]">
                    <div className="text-xs text-[var(--sd-text-secondary)] uppercase tracking-wider mb-2">Current Resources</div>
                    <div className="space-y-2">
                      {Object.entries(resources).slice(0, 6).map(([key, value]) => (
                        <div key={key} className="flex justify-between items-center">
                          <span className="text-xs text-[var(--sd-text-secondary)]">{RESOURCE_LABELS[key] || key}</span>
                          <span className={`text-sm font-mono font-bold ${RESOURCE_COLORS[key] || "text-[var(--sd-text-primary)]"}`}>
                  ...
                  <div className="bg-[var(--sd-panel-bottom)] rounded-lg p-4 border border-[var(--sd-panel-border)]">
                    <div className="text-xs text-[var(--sd-text-secondary)] uppercase tracking-wider mb-2">Energy Status</div>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        <span className="text-xs text-[var(--sd-text-secondary)]">Consumption</span>
                        <span className="text-sm font-mono font-bold text-red-600">
                          {getTotalEnergyConsumption().toLocaleString()}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-xs text-[var(--sd-text-secondary)]">Available</span>
                  ...
                  <div className="bg-[var(--sd-panel-bottom)] rounded-lg p-4 border border-[var(--sd-panel-border)]">
                    <div className="text-xs text-[var(--sd-text-secondary)] uppercase tracking-wider mb-2">Production Stats</div>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        <span className="text-xs text-[var(--sd-text-secondary)]">Throughput</span>
                        <span className="text-sm font-mono font-bold text-blue-600">{getTotalThroughput()}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-xs text-[var(--sd-text-secondary)]">Active Recipes</span>
                        <span className="text-sm font-mono font-bold text-purple-600">
                          {Object.keys(activeRecipes).length}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-xs text-[var(--sd-text-secondary)]">Recipes Unlocked</span>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {Object.entries(activeRecipes).map(([recipe, count]) => (
                    <div key={recipe} className="bg-[var(--sd-panel-bottom)] rounded-lg p-3 border border-[var(--sd-panel-border)]">
                      <div className="text-xs text-[var(--sd-text-secondary)] mb-1">{recipe}</div>
                      <div className="text-xl font-orbitron font-bold text-[var(--sd-text-primary)]">{count}</div>
                      <div className="text-[10px] text-[var(--sd-text-secondary)]">Active lines</div>
                    </div>
                  ))}
                      ...
                      return (
                        <Card key={type.id} className={cn("border", type.color.replace("text-", "border-") + "/30")}>
                          <CardContent className="p-4 space-y-3">
                            <div className="flex items-center gap-3">
                              <div className={cn("p-2 rounded-lg bg-[var(--sd-panel-bottom)]", type.color)}>
                                <Icon className="w-5 h-5" />
                              </div>
                              <div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {refineries.map(refinery => (
                    <div key={refinery.id} className="bg-[var(--sd-panel-bottom)] rounded-lg p-4 border border-[var(--sd-panel-border)]">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center gap-3">
                          <div className={cn("p-2 rounded-lg bg-[var(--sd-panel-top)]", refinery.typeDef?.color)}>
                            {React.createElement(ICON_MAP[refinery.typeDef?.icon] || Hammer, { className: "w-5 h-5" })}
                          </div>
                          <div>
                            <div className="font-semibold text-[var(--sd-text-primary)]">{refinery.typeDef?.name}</div>
                            <div className="text-xs text-[var(--sd-text-secondary)]">Level {refinery.level} • {refinery.isActive ? "Active" : "Idle"}</div>
                          </div>
                        </div>
                        <Badge variant={refinery.isActive ? "default" : "secondary"} className="text-[10px]">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                        <div className="bg-[var(--sd-panel-top)] rounded p-2 border border-[var(--sd-panel-border)]">
                          <div className="text-[var(--sd-text-secondary)] mb-1">Throughput</div>
                          <div className="font-mono font-bold text-[var(--sd-text-primary)]">{refinery.throughput}</div>
                        </div>
                        <div className="bg-[var(--sd-panel-top)] rounded p-2 border border-[var(--sd-panel-border)]">
                          <div className="text-[var(--sd-text-secondary)] mb-1">Total Processed</div>
                          <div className="font-mono font-bold text-[var(--sd-text-primary)]">{(refinery.totalProcessed || 0).toLocaleString()}</div>
                        </div>
                        <div className="bg-[var(--sd-panel-top)] rounded p-2 border border-[var(--sd-panel-border)]">
                          <div className="text-[var(--sd-text-secondary)] mb-1">Efficiency</div>
                          <div className="font-mono font-bold text-green-600">{Math.round(refinery.efficiency * 100)}%</div>
                        </div>
                        <div className="bg-[var(--sd-panel-top)] rounded p-2 border border-[var(--sd-panel-border)]">
                          <div className="text-[var(--sd-text-secondary)] mb-1">Last Collection</div>
                          <div className="font-mono font-bold text-[var(--sd-text-primary)]">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-6">
                  {/* Efficiency Metrics */}
                  <div>
                    <h3 className="text-sm font-bold text-[var(--sd-text-primary)] mb-3">Efficiency Metrics</h3>
                  ...
                  {/* Recipe Analysis */}
                  <div>
                    <h3 className="text-sm font-bold text-[var(--sd-text-primary)] mb-3">Recipe Distribution</h3>
                    <div className="space-y-2">
                      {Object.entries(activeRecipes).map(([recipe, count]) => (
                        <div key={recipe} className="bg-[var(--sd-panel-bottom)] rounded-lg p-3 border border-[var(--sd-panel-border)]">
                          <div className="flex items-center justify-between mb-2">
                            <div className="text-sm font-semibold text-[var(--sd-text-primary)]">{recipe}</div>
                            <div className="text-xs font-mono text-[var(--sd-text-secondary)]">{count} active</div>
                          </div>
                  ...
                  {/* Energy Analysis */}
                  <div>
                    <h3 className="text-sm font-bold text-[var(--sd-text-primary)] mb-3">Energy Consumption Analysis</h3>
                    <div className="bg-[var(--sd-panel-bottom)] rounded-lg p-4 border border-[var(--sd-panel-border)]">
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div>
                          <div className="text-xs text-[var(--sd-text-secondary)] mb-1">Total Consumption</div>
                          <div className="text-lg font-orbitron font-bold text-red-600">
                            {getTotalEnergyConsumption().toLocaleString()}
                          </div>
                        </div>
                        <div>
                          <div className="text-xs text-[var(--sd-text-secondary)] mb-1">Available Energy</div>
                          <div className="text-lg font-orbitron font-bold text-green-600">
                            {(resources.energy || 0).toLocaleString()}
                          </div>
                        </div>
                        <div>
                          <div className="text-xs text-[var(--sd-text-secondary)] mb-1">Utilization</div>
                        ...
                        <div>
                          <div className="text-xs text-[var(--sd-text-secondary)] mb-1">Status</div>
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-[var(--sd-text-primary)] mb-3">Resource Processing Summary</h3>
                    <div className="bg-[var(--sd-panel-bottom)] rounded-lg p-4 border border-[var(--sd-panel-border)]">
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        <div>
                          <div className="text-xs text-[var(--sd-text-secondary)] mb-2">Total Refineries Built</div>
                          <div className="text-2xl font-orbitron font-bold text-[var(--sd-text-primary)]">{stats?.totalRefineries || 0}</div>
                        </div>
                        <div>
                          <div className="text-xs text-[var(--sd-text-secondary)] mb-2">Currently Active</div>
                          <div className="text-2xl font-orbitron font-bold text-green-600">{stats?.activeRefineries || 0}</div>
                        </div>
                        <div>
                          <div className="text-xs text-[var(--sd-text-secondary)] mb-2">Total Processed</div>
                          <div className="text-2xl font-orbitron font-bold text-blue-600">
                            {(stats?.totalProcessed || 0).toLocaleString()}
                          </div>
                        </div>
                        <div>
                          <div className="text-xs text-[var(--sd-text-secondary)] mb-2">Recipes Unlocked</div>
                          <div className="text-2xl font-orbitron font-bold text-purple-600">{stats?.recipesUnlocked || 0}</div>
                        </div>
                        <div>
                          <div className="text-xs text-[var(--sd-text-secondary)] mb-2">Avg Efficiency</div>
                          <div className="text-2xl font-orbitron font-bold text-amber-600">
                            {Math.round((stats?.efficiency || 0) * 100)}%
                          </div>
                        </div>
                        <div>
                          <div className="text-xs text-[var(--sd-text-secondary)] mb-2">Energy per Unit</div>
                  ...
                  {/* Recipe Information */}
                  <div>
                    <h3 className="text-sm font-bold text-[var(--sd-text-primary)] mb-3">Recipe Information & Game Logic</h3>
                    <div className="bg-[var(--sd-panel-bottom)] rounded-lg p-4 border border-[var(--sd-panel-border)]">
                      <div className="space-y-3 text-xs text-[var(--sd-text-secondary)]">
                        <div>
                          <div className="font-bold text-[var(--sd-text-secondary)] mb-1">Basic Processing Recipes</div>
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-[var(--sd-text-primary)] mb-3">Upgrade System & Progression</h3>
                    <div className="bg-[var(--sd-panel-bottom)] rounded-lg p-4 border border-[var(--sd-panel-border)]">
                      <div className="space-y-3 text-xs text-[var(--sd-text-secondary)]">
                        <div>
                          <div className="font-bold text-[var(--sd-text-secondary)] mb-1">Level Progression</div>
