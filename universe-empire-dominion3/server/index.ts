...
import { registerOGameGalaxyRoutes } from "./routes-ogame-galaxy";
import { registerOGameGalaxyEnhancedRoutes } from "./routes-ogame-galaxy-enhanced";
...
(async () => {
  ...
  registerOGameGalaxyRoutes(app);
  registerOGameGalaxyEnhancedRoutes(app);
