...
export const EXOTIC_TECHNOLOGIES: Research[] = [
  ...
  {
    id: 'stealth-1',
    name: 'Basic Countermeasures',
    branch: 'espionage',
    tier: 3,
    maxLevel: 999,
    description: 'Basic stealth and signal masking techniques',
    icon: '👻',
    category: 'Foundational',
  },
  {
    ...
    tier: 8,
    maxLevel: 999,
    description: 'Adaptive camouflage systems for ships and installations',
    icon: '👻👻',
    category: 'Intermediate',
  },
  {
    ...
    tier: 15,
    maxLevel: 999,
    description: 'Bend light and sensors around vessels',
    icon: '🫥',
    category: 'Advanced',
  },
  {
    id: 'stealth-4',
    name: 'Quantum Cloaking',
    branch: 'espionage',
    tier: 25,
    maxLevel: 999,
    description: 'Quantum-level concealment undetectable by standard sensors',
    icon: '🫥🫥',
    category: 'Expert',
  },
  {
    ...
    tier: 40,
    maxLevel: 999,
    description: 'Shift ships partially out of phase with normal space',
    icon: '🌀',
    category: 'Master',
  },
  {
    ...
    tier: 10,
    maxLevel: 999,
    description: 'Theoretical understanding of wormhole physics',
    icon: '🕳️',
    category: 'Foundational',
  },
  {
    id: 'wormhole-2',
    name: 'Wormhole Detection',
    branch: 'exotic',
    tier: 15,
    maxLevel: 999,
    description: 'Sensor systems capable of detecting stable wormholes',
    icon: '🕳️🕳️',
    category: 'Intermediate',
  },
  {
    ...
    tier: 22,
    maxLevel: 999,
    description: 'Field generators that stabilize wormholes for transit',
    icon: '🌀',
    category: 'Advanced',
  },
  {
    id: 'wormhole-4',
    name: 'Artificial Wormhole',
    branch: 'exotic',
    tier: 35,
    maxLevel: 999,
    description: 'Create stable artificial wormholes between points',
    icon: '🌀🌀',
    category: 'Expert',
  },
  {
    ...
    tier: 50,
    maxLevel: 999,
    description: 'Network of interconnected stable wormholes spanning galaxies',
    icon: '🌐',
    category: 'Master',
  },
];
