...
export {
  STORY_ACT_VISUALS,
  STORY_VISUAL_TOTAL_ACTS,
  STORY_VISUAL_TOTAL_CHAPTERS,
  STORY_VISUAL_TOTAL_MISSIONS_PER_CHAPTER,
  STORY_VISUAL_GENERATED_ACTS,
  STORY_VISUAL_FALLBACK_ACTS,
  STORY_VISUAL_STYLE,
  STORY_VISUAL_VIDEO_PATH,
  STORY_VISUAL_AUDIO_PATH,
  getStoryActVisual,
  getStoryActVisuals,
  getStoryVisuals,
  getStoryMissionVisual,
  getStoryActImagePath,
  getStoryChapterImagePath,
  getStoryMissionImagePath,
  getStoryActAlertLevel,
  getStoryChapterLabel,
  getStoryBriefingCopy,
  getStoryBriefingTitle,
  getStoryMissionFrame,
  getStoryAlertLabel,
  getStoryVisualFallback,
  getStoryVisualAlt,
  getStoryVisualPalette,
  getStoryVisualThemeClass,
  getStoryVisualOverlayClass,
  getStoryVisualBadgeClass,
  getStoryVisualProgressTone,
  getGeneratedStoryArtActs,
  hasGeneratedStoryArt,
